...
if (!config) {
    ...
    config = {
        ...
        surfaces: [
            ...
            { name: "CC Anterior", path: "freesurfer/surfaces/CC_Anterior.vtk" },
            { name: "CC Central", path: "freesurfer/surfaces/CC_Central.vtk" },
            { name: "CC Mid Anterior", path: "freesurfer/surfaces/CC_Mid_Anterior.vtk" },
            { name: "CC Mid Posterior", path: "freesurfer/surfaces/CC_Mid_Posterior.vtk" },
            { name: "CC Posterior", path: "freesurfer/surfaces/CC_Posterior.vtk" },
